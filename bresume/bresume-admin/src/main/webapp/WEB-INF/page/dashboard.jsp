			...
			<div class="col-xs-12">
				...
				<div class="alert alert-block alert-success">
					...
					<i class="ace-icon fa fa-check green"></i> Welcome to <strong
						class="green"> Ace <small>(v1.3.1)</small>
									...
									<div class="tab-content padding-8">
										...
										<div id="member-tab" class="tab-pane">
											<div class="clearfix">
												<div class="itemdiv memberdiv">
													<div class="user">
														<img alt="Bob Doe's avatar" src="/resource/site/avatars/user.jpg" />
													</div>
												...
												<div class="itemdiv memberdiv">
													<div class="user">
														<img alt="Joe Doe's avatar"
															src="/resource/site/avatars/avatar2.png" />
													</div>
												...
												<div class="itemdiv memberdiv">
													<div class="user">
														<img alt="Jim Doe's avatar"
															src="/resource/site/avatars/avatar.png" />
													</div>
												...
												<div class="itemdiv memberdiv">
													<div class="user">
														<img alt="Alex Doe's avatar"
															src="/resource/site/avatars/avatar5.png" />
													</div>
												...
												<div class="itemdiv memberdiv">
													<div class="user">
														<img alt="Susan's avatar" src="/resource/site/avatars/avatar3.png" />
													</div>
												...
												<div class="itemdiv memberdiv">
													<div class="user">
														<img alt="Phil Doe's avatar"
															src="/resource/site/avatars/avatar4.png" />
													</div>
												...
												<div class="itemdiv memberdiv">
													<div class="user">
														<img alt="Alexa Doe's avatar"
															src="/resource/site/avatars/avatar1.png" />
													</div>
										...
										<div id="comment-tab" class="tab-pane">
											<div class="comments">
												...
												<div class="itemdiv commentdiv">
													<div class="user">
														<img alt="Joe's Avatar" src="/resource/site/avatars/avatar2.png" />
													</div>
												...
												<div class="itemdiv commentdiv">
													<div class="user">
														<img alt="Rita's Avatar" src="/resource/site/avatars/avatar3.png" />
													</div>
								...
								<div class="widget-main no-padding">
									<div class="dialogs">
										<div class="itemdiv dialogdiv">
											<div class="user">
												<img alt="Alexa's Avatar" src="/resource/site/avatars/avatar1.png" />
											</div>
										...
										<div class="itemdiv dialogdiv">
											<div class="user">
												<img alt="John's Avatar" src="/resource/site/avatars/avatar.png" />
											</div>
										...
										<div class="itemdiv dialogdiv">
											<div class="user">
												<img alt="Bob's Avatar" src="/resource/site/avatars/user.jpg" />
											</div>
										...
										<div class="itemdiv dialogdiv">
											<div class="user">
												<img alt="Jim's Avatar" src="/resource/site/avatars/avatar4.png" />
											</div>
...
<!-- basic scripts -->
		...
		<script src="/resource/site/js/jquery.sparkline.min.js"></script>
		<script src="/resource/site/js/flot/jquery.flot.min.js"></script>
		<script src="/resource/site/js/flot/jquery.flot.pie.min.js"></script>
		<script src="/resource/site/js/flot/jquery.flot.resize.min.js"></script>
