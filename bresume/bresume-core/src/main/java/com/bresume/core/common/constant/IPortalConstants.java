...
public interface IPortalConstants extends IConstants
{
	...
	public static final String	MERCHANT_STATUS_UN_ACTIVE		= "0A";
	public static final String	MERCHANT_STATUS_ACTIVEED		= "0B";
	public static final String	MERCHANT_STATUS_STOP			= "0C";
	public static final String	MERCHANT_STATUS_DELETED			= "0D";
