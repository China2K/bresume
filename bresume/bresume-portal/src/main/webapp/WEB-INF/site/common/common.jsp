			...
			<div class="modal-header">
				<ul class="nav nav-pills nav-pills-list nav-justified">
					<li class="active"><a data-toggle="tab"
						id="email_sign_in_header" href="#email_sign_in_tab">登录<span>Sign
								In</span></a></li>
					<li class=""><a data-toggle="tab" id="email_sign_up_header"
						href="#email_sign_up_tab">注册<span>Sign Up</span></a></li>
				</ul>
			</div>
			<div class="modal-body">
				<div class="tab-content">
					<div class="tab-pane active" id="email_sign_in_tab">
						<form accept-charset="UTF-8" action="<c:url value='/user/login'/>"
							onsubmit="return false;" class="simple_form new_user"
							data-remote="true" id="login_form" method="post">
							...
							<div class="form-group">
								<div class="input-group">
									<span class="input-group-addon"><i
										...
										class="form-control validate[required,custom[email],minSize[6],maxSize[100]]"
										name="loginName" placeholder="邮箱地址" required="required">
								</div>
							</div>
							<div class="form-group">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-key"></i></span><input
										class="form-control validate[required,minSize[6],maxSize[100]]"
										id="user_password" name="password" placeholder="密码"
							...
							<div class="form-group addon">
								...
								<div class="input-group checkbox col-md-10" id="remember_me">
									<label> <input checked="checked" id="user_remember_me"
										name="remember_me" type="checkbox" value="1">记住我
									</label> &nbsp;&nbsp;&nbsp;&nbsp; <a href="/user/forget"> <i
										class="fa fa-question-circle"></i>忘记密码？
									</a>
								</div>
